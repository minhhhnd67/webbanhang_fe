      ...
      <el-row type="flex" justify="center" style="height: 800px;">
        <el-col :span="12" style="background-color: #ffd400; border-radius: 30px;">
          ...
          <el-row style="margin-top: 20px;" type="flex" justify="center">
            <el-col :span="16">
              <el-input placeholder="Mật khẩu" v-model="ruleForm.password" show-password>
          ...
          <el-row style="margin-top: 20px;" type="flex" justify="center">
            <el-col :span="16">
              <el-input placeholder="Nhập lại mật khẩu" v-model="ruleForm.password_confirm" show-password>
          ...
          <el-row style="margin-top: 20px;" type="flex" justify="center">
            <el-col :span="16">
              <el-input placeholder="Số điện thoại" v-model="ruleForm.phone" show-password>
          ...
          <el-row style="margin-top: 20px;" type="flex" justify="center">
            <el-col :span="16">
              <el-button style="width: 100%; background-color: #ff5100; color: #ffffff;">Đăng ký</el-button>
            </el-col>
          </el-row>
          <el-row style="margin-top: 10px;" type="flex" justify="center">
            <el-col :span="16">
              <el-button @click="login()" style="width: 100%; background-color: #696765; color: #ffffff;">Về trang đăng nhập</el-button>
            </el-col>
          </el-row>
        </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    login() {
      router.push({ name: "c-login" }).catch(() => {});
    },
    submitForm(formName) {
